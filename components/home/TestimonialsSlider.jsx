...
const testimonials = [
  {
    ...
    message:
      "From tiling to pool renovations, EMME's team exceeded our expectations with their professionalism and keen attention to detail. As leading Malta hotel maintenance contractors, they come highly recommended!",
    rating: 5,
    avatar: "AM",
  },
  {
    ...
    message:
      "We count on EMME for our ongoing yacht upgrades, and they never disappoint. Always responsive, efficient, and committed to top-quality results—truly experts in hospitality maintenance services Malta.",
    rating: 5,
    avatar: "CJ",
  },
  {
    ...
    message:
      "EMME Construction showcased exceptional precision during our luxury hotel renovation. As trusted Malta hotel maintenance contractors, they delivered ahead of schedule with outstanding quality that went beyond our expectations.",
    rating: 5,
    avatar: "RT",
  },
  {
    ...
    message:
      "The high-end finishes and flawless execution on every EMME project I've witnessed are truly unmatched. Their hotel maintenance services Malta set a benchmark for excellence.",
    rating: 5,
    avatar: "EB",
  },
  {
    ...
    message:
      "Working with EMME was a masterclass in professional construction. Their expertise in premium finishes and smooth project management truly sets them apart, especially in delivering top-quality hotel maintenance services Malta.",
    rating: 5,
    avatar: "MD",
  },
  {
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Hear from clients who have experienced the EMME standard of excellence in hospitality maintenance services Malta.
          </p>
        </div>
