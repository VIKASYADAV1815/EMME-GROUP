        ...
        <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-6xl px-4 py-20 text-center text-white">
                ...
                >
                    ...
                    >
                      Committed to enhancing hospitality standards through expert hotel maintenance services Malta, professional pool care, high-quality renovations, and 24/7 dedicated support.
                    </motion.p>

                    {/* Buttons */}
                    <motion.div
                        className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-10 max-w-md mx-auto sm:max-w-none"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto px-8 py-4 bg-[#584910] text-white font-bold rounded-lg text-base shadow-lg hover:shadow-xl transition-all"
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto px-8 py-4 border-2 border-[#584910] text-white font-bold rounded-lg text-base hover:bg-[#584910]/10 transition-all"
