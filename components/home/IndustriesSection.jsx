...
const industries = [
  {
    ...
    description: "Premium renovations, interior enhancements, and expert hotel maintenance services Malta tailored for the luxury hospitality sector.",
    icon: <FaHotel />,
  },
  {
    title: "Yachts",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
           We deliver tailored construction excellence with specialized expertise across various sectors, including top-tier hotel maintenance services Malta.
          </motion.p>
        </div>
