            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p
                        ...
                        data-aos-delay="200"
                    >
                        Customized solutions designed to meet the highest standards of marine and hospitality maintenance services Malta.
                    </p>
                </div>
                ...
                >
                    <div className="flex flex-col lg:flex-row">
                        <div className="lg:w-1/2 p-8 md:p-10 flex flex-col justify-center">
                            ...
                            <Link href="/yacht-services" className="w-full sm:w-auto">
                                <span className="inline-flex items-center justify-center w-full sm:w-auto bg-[#584910] text-white px-8 py-3.5 rounded-full text-base font-bold hover:bg-[#483a0c] transition-all duration-300 group shadow-md hover:shadow-lg">
                                    Learn More
                ...
                >
                    <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/2 p-8 md:p-10 flex flex-col justify-center order-1 lg:order-2">
                            ...
                            <Link href="/hotelcare" className="w-full sm:w-auto">
                                <span className="inline-flex items-center justify-center w-full sm:w-auto bg-[#584910] text-white px-8 py-3.5 rounded-full text-base font-bold hover:bg-[#483a0c] transition-all duration-300 group shadow-md hover:shadow-lg">
                                    Learn More
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
