                ...
                >
                    ...
                    >
                        <p className="text-[#555] text-base md:text-lg mb-6 font-light leading-relaxed">
                            Whether you're planning a hotel renovation or a yacht transformation, our specialists provide expert hotel maintenance services Malta with premium craftsmanship and reliable, on-time delivery.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="w-full sm:w-auto px-8 py-3.5 bg-[#584910] text-white rounded-full font-bold hover:bg-[#b8a86e] transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-base"
